...
| Metric | Value | Source |
|---|---|---|
| **Baseline Accuracy** | **100%** | `../../../../validation/reports/production_extractor_accuracy_report.json` |
| Baseline Timestamp | 2026-06-16T23:17:43.093Z | `../../../../validation/reports/production_extractor_accuracy_report.json` |
| Fields Tested | 60 (4 fields × 15 documents) | `../../../../validation/reports/production_extractor_accuracy_report.json` |
| Extractor Source | `extractDocumentData()` — `src/lib/extractor.ts` | `../../../../validation/reports/production_extractor_accuracy_report.json` |
...
| Property | Value |
|---|---|
| **File** | `../../../../validation/datasets/procurement_dataset.json` |
...
| **PDFs** | 15 files in `../../../../validation/datasets/` |
