 ...
 *   - Reads from validation/datasets/ (read-only).
...
const GROUND_TRUTH_PATH = path.join(ROOT, "validation/datasets", "procurement_dataset.json");
...
(async () => {
  ...
  const report = {
    metadata: {
      ...
      groundTruthSource:   "validation/datasets/procurement_dataset.json",
